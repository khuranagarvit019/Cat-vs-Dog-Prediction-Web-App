...
from dog_cat.preprocessing_utilities import (
    read_img_from_path,
    resize_img,
    read_from_file,
)
from dog_cat.utils import download_model
...
class ImagePredictor:
    ...
    def init_from_config_path(cls, config_path):
        """Function To Config Model through given Path"""
    ...
    def init_from_config_url(cls, config_path):
        """Function To Configure Model Through URL"""
        with open(config_path, "r") as f:
            config = yaml.load(f, yaml.SafeLoader)
    ...
    def predict_from_array(self, arr):
        """Function To Predict From image array"""
